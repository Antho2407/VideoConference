...
exports.run = function (config) {
  ...
  .on('connection', function (socket) {
    ...
    socket.on('sendPosition', function (position, roomId) {

    console.log("SEND POSITION" +position.latitude);
    var newLocation = {
        idClient : socket.id,
    ...
    rooms[currentRoom].forEach(function (s) {
          s.emit('newPositions', tabLocations[roomId]);
        });
  });
